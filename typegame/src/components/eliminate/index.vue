...
export default {
  ...
  data() {
    return {
      ...
      itemed: [],
      //页面显示的单词
      learning: ['stretch', 'space-between', 'space-evenly', 'border-radius', 'flex-direction', 'autoplay', 'nowrap', 'row-reverse', 'column', 'column-reverse', 'flex-wrap', 'wrap', 'wrap-reverse', 'justify-content', 'align-items', 'align-self', 'align-content', 'flex-grow', 'flex-shrink', 'flex-basis'],
    }
  },
  methods: {
    //开始按钮
